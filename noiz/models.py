...
class ProcessingConfig (db.Model):
    ...
    window_spectrum_reject_method = db.deferred(db.Column('window_spectrum_reject_method', db.Text))
    ...
    sequence_reject_method = db.deferred(db.Column('sequence_reject_method', db.Text))
    ...
    filter_type = db.deferred(db.Column('filter_type', db.Text))
    # taper to be used in time domain before fft
    # 'cosine'
    # 'hanning'
    #
    taper_time_type = db.deferred(db.Column('taper_time_type', db.Text))
    ...
    # 'cosine'
    # 'hanning'
    taper_freq_type = db.deferred(db.Column('taper_freq_type', db.Text))
    # width of the transition region in cosine taper
