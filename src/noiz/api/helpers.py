...
from noiz.models import Crosscorrelation, CCFStack, DatachunkStats, ProcessedDatachunk
...
BulkAddableObjects = Collection[Union[Crosscorrelation, CCFStack, DatachunkStats, ProcessedDatachunk]]
