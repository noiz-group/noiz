...
@pytest.mark.parametrize(
    ...
    (
        (
            Component(lat=1, lon=1, start_date=datetime.datetime(2016, 1, 1), end_date=datetime.datetime(2020, 1, 1)),
            Component(lat=2, lon=2, start_date=datetime.datetime(2016, 1, 1), end_date=datetime.datetime(2020, 1, 1)),
            False,
        ),
        (
            Component(lat=1, lon=1, start_date=datetime.datetime(2016, 1, 1), end_date=datetime.datetime(2020, 1, 1)),
            Component(
                lat=-10, lon=-2, start_date=datetime.datetime(2016, 1, 1), end_date=datetime.datetime(2020, 1, 1)
            ),
            True,
        ),
        (
